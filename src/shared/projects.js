...
export const PROJECTS = [
     {
        ...
        role:"Conducted user research on webinar IA, Consulted adjacent teams on design and implementation of reports and emails, Created user stories, core tasks and objectives based on team’s consolidated understanding and previous research, Designed user flows of the scheduling side , Hosted cross-team, cross-functional workshops to align on content design, Worked with engineering and PMs to implement designs ",
